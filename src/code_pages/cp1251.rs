...
impl CP1251 {
    ...
    /// Decode a single CP1251 byte into its corresponding character.
    ///
    ...
    /// Encode a single Unicode `char` to its CP1251 byte, or `None` if
